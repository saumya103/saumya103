...
## 🕵️ Featured Cyber Projects - 🔍 **Penetration Testing Scripts** – Automating reconnaissance, scanning, and exploitation. - 🛡️ **Web Application Firewall (WAF)** – AI‑powered detection of SQLi, XSS, CSRF. - 📊 **Threat Monitoring Dashboards** – Splunk & custom log analysis pipelines. - 🧩 **Steganography & Cryptography Tools** – Secure data hiding and encryption utilities. 
# 📊 GitHub Stats:
